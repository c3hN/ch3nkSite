...
//
//    @Override
//    public List<SysRole> findRolesForUser(String userId) {
//        if (StringUtils.isNotEmpty(userId)) {
//            List<SysRole> list = sysUserMapper.selectRolesForUser(userId);
//            return list;
//        }
//        return null;
//    }
...
//        }
//        String md5 = new Md5Hash(userPwd).toHex();
...
//
//    @Override
//    public int saveRolesForUser(String userId, String[] roleIds) {
//        return sysUserMapper.insertRolesForUser(userId,roleIds);
//    }
//
//    @Override
...
//
//    @Override
//    public int updateUserStateBatch(String[] userIds, String deleteFlag) {
//        return sysUserMapper.updateStateByPkBatch(userIds,deleteFlag);
//    }
//
//    @Override
...
//        sysUserMapper.deleteBatchByPK(userIds);
//    }
//
//    @Override
//    public void deleteRolesForUser(String userId) {
//        sysUserMapper.deleteRolesForUser(userId);
//    }
//
//    /**
//     * 用户导入
